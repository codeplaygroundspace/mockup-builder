...
const SOLID_SWATCHES: ReadonlyArray<FrameBackgroundSwatch> = [
  { label: "Soft White", className: "bg-[#f8f9fa]" },
  { label: "Pale Gray", className: "bg-[#dee2e6]" },
  { label: "Cool Gray", className: "bg-[#adb5bd]" },
  { label: "Slate Gray", className: "bg-[#495057]" },
  { label: "Charcoal", className: "bg-[#212529]" },
  { label: "Near Black", className: "bg-[#151617]" },
  { label: "Coral Red", className: "bg-[#ff595e]" },
  { label: "Tangerine Solid", className: "bg-[#ff924c]" },
  { label: "Marigold", className: "bg-[#ffca3a]" },
  { label: "Acid Lime", className: "bg-[#c5ca30]" },
  { label: "Grass", className: "bg-[#8ac926]" },
  { label: "Clover", className: "bg-[#3fc95d]" },
  { label: "Rose Milk", className: "bg-[#ffadad]" },
  { label: "Apricot", className: "bg-[#ffc2a9]" },
  { label: "Sand", className: "bg-[#ffd6a5]" },
  { label: "Lemon Chiffon", className: "bg-[#fdffb6]" },
  { label: "Soft Mint", className: "bg-[#caffbf]" },
  { label: "Pistachio", className: "bg-[#c3ffd0]" },
  { label: "Teal", className: "bg-[#36949d]" },
  { label: "Azure Solid", className: "bg-[#1982c4]" },
  { label: "Steel Blue", className: "bg-[#4267ac]" },
  { label: "Slate Violet", className: "bg-[#565aa0]" },
  { label: "Plum Solid", className: "bg-[#6a4c93]" },
  { label: "Raspberry", className: "bg-[#ee4b86]" },
  { label: "Seafoam", className: "bg-[#b3fbdf]" },
  { label: "Powder Cyan", className: "bg-[#aae0ef]" },
  { label: "Cornflower", className: "bg-[#a0c4ff]" },
  { label: "Lavender", className: "bg-[#bdb2ff]" },
  { label: "Lilac", className: "bg-[#ffc6ff]" },
  { label: "Blossom", className: "bg-[#ffc7ec]" },
];
